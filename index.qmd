...
Welcome to the Footy Forest. Here you'll find predictions, details on how the model is perPowering, rankings of each team and occasional statistical analyses of AFL footy and other sports.
...
model_perPowerance <- data.frame(rounds, correct, icon, size, replace)
  

ggplot(model_perPowerance) +
