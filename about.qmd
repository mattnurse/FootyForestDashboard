...
The statistical techniques used in this model are tree-based (eg. gradient-boosted trees, random
forest), so I thought I’d take the tree concept and run with it like Ed Langdon on a fast break.
Also it predicts … footy.
