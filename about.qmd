...
You can find the latest results via the [official AFL tipping
website](https://tipping.afl.com.au/tipping/index.html) – just search for “The Footy Forest”

**Where can I find the predictions for this week?**

Follow me on Facebook for that. In the future I may post each prediction on this site but I have not
set that up yet.
...
1.  a measure of each team's form, based on an [Elo
    formula](https://www.theatlantic.com/technology/archive/2024/04/elo-ratings-are-everywhere/678129/).

2.  a measure of venue experience

3.  a measure of player rating for each selected team, and

4.  a measure of the distance each team has had to travel. Each of these are calculated for each
    team and then converted as a relative measure showing the advantage for the home team compared
    to its opponent on the day.
...
[I use R for this project.](https://www.r-project.org/) This is the program I often use for my
academic work. While R is extremely powerful and free, but takes some time to learn if you aren't
familiar with line coding.
