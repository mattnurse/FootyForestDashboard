...
The statistical techniques used in this model are "tree-based", so I thought I’d take the tree
...
published some academic work using machine learning techniques, [there are many more qualified
people than me who have produced similar models](https://squiggle.com.au/). Prior to this I worked
in various communication roles.
